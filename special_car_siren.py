...
print ("Location:"+str(res["lat"]) + " " + str(res["lng"]) + " "+ "Accuracy:"+ str(res["accuracy"]))
messages=mqttPublishMultiple.publish_location(str(res["lat"]),str(res["lng"]),"special_with_siren",str(res["accuracy"]))
...
#Publish Location information to Traffic Light
#loc_msg=mqttPublishMultiple.publish_location(res["lat"],res["lng"],"special_car")
#print("Message after publishing"+loc_msg)
#end
